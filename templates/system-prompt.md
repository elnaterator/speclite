...
Project-specific instructions for the speclite workflow. **Every speclite skill reads this
file first and treats it as the highest-priority instruction set — it overrides any
